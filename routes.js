...
module.exports = routes({ locale: defaultLocale, hideDefaultLocale: true })
  .add('home', 'en', '{/}?{/page/:page([\\d]+)}?{/per-page/:perPage([\\d]+)}?{/filter/:filter}?{/order/:order}?', 'home')
  .add('home', 'ja', '{/}?{/page/:page([\\d]+)}?{/per-page/:perPage([\\d]+)}?{/filter/:filter}?{/order/:order}?', 'home')
  .add('home', 'ko', '{/}?{/page/:page([\\d]+)}?{/per-page/:perPage([\\d]+)}?{/filter/:filter}?{/order/:order}?', 'home')
  .add('home', 'nl', '{/}?{/bladzijde/:page([\\d]+)}?{/per-pagina/:perPage([\\d]+)}?{/filter/:filter}?{/bestellen/:order}?', 'home')
  .add('home', 'zh', '{/}?{/page/:page([\\d]+)}?{/per-page/:perPage([\\d]+)}?{/filter/:filter}?{/order/:order}?', 'home')
