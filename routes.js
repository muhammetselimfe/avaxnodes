...
module.exports = routes({ locale: defaultLocale, hideDefaultLocale: true })
  .add('home', 'en', '{/}?{/page/:page([\\d]+)}?{/per-page/:perPage([\\d]+)}?{/filter/:filter}?{/sorting/:sorting}?', 'home')
  .add('home', 'ja', '{/}?{/page/:page([\\d]+)}?{/per-page/:perPage([\\d]+)}?{/filter/:filter}?{/sorting/:sorting}?', 'home')
  .add('home', 'ko', '{/}?{/page/:page([\\d]+)}?{/per-page/:perPage([\\d]+)}?{/filter/:filter}?{/sorting/:sorting}?', 'home')
  .add('home', 'nl', '{/}?{/bladzijde/:page([\\d]+)}?{/per-pagina/:perPage([\\d]+)}?{/filter/:filter}?{/sorteren/:sorting}?', 'home')
  .add('home', 'zh', '{/}?{/page/:page([\\d]+)}?{/per-page/:perPage([\\d]+)}?{/filter/:filter}?{/sorting/:sorting}?', 'home')

  .add('node', 'en', '/node/:id{/page/:page([\\d]+)}?{/per-page/:perPage([\\d]+)}?', 'node')
  .add('node', 'ja', '/node/:id{/page/:page([\\d]+)}?{/per-page/:perPage([\\d]+)}?', 'node')
  .add('node', 'ko', '/node/:id{/page/:page([\\d]+)}?{/per-page/:perPage([\\d]+)}?', 'node')
  .add('node', 'nl', '/knooppunt/:id{/bladzijde/:page([\\d]+)}?{/per-pagina/:perPage([\\d]+)}?', 'node')
  .add('node', 'zh', '/node/:id{/page/:page([\\d]+)}?{/per-page/:perPage([\\d]+)}?', 'node')
